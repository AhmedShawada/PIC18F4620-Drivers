...
#define Receiver_Disable()         (RCSTAbits.CREN = 0)
#define Receiver_Enable()          (RCSTAbits.CREN = 1)

#define TX_Input_Configuration()   (TRISCbits.RC6 = 1)
#define RX_Input_Configuration()   (TRISCbits.RC7 = 1)
