...
#define Serial_Clock_Configuration()   (TRISCbits.TRISC3 = 1)
#define Serial_Data_Configuration()    (TRISCbits.TRISC4 = 1)

/* Clear the Write Collision Detect */
#define Clear_Write_Collision()       (SSPCON1bits.WCOL = 0)

/* Clear the Receive Overflow Indicator */
#define Clear_Receive_Overflow()       (SSPCON1bits.SSPOV = 0)
