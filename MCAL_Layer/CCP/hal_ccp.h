 ...
 *
 * Created on October 11, 2024, 7:14 PM
 */
...
/*
  @Summary      Defines the available instances of Capture/Compare/PWM (CCP) modules.   
  @Description  (CCP1_INST refers to the first CCP instance) (CCP2_INST refers to the second CCP instance).
*/
typedef enum{
    CCP1_INST = 0,
    CCP2_INST
...
/*
  @Summary      Defines the timer configurations for the CCP1 and CCP2 modules.

  @Description  This enumeration specifies which timers are used for the CCP1 and CCP2 Capture/Compare/PWM (CCP) modules.
*/
typedef enum{
    CCP1_CCP2_TIMER3 = 0,
